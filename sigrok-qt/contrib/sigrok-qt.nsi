...
#
# This file is used to create the sigrok-qt Windows installer via NSIS.
#
# NSIS documentation:
...
OutFile "sigrok-qt-0.1.0-installer.exe"
...
Section "sigrok-qt (required)" Section1
	...
	CreateDirectory "$SMPROGRAMS\sigrok\sigrok-qt"

	# Create a shortcut for the Qt GUI application.
	CreateShortCut "$SMPROGRAMS\sigrok\sigrok-qt\sigrok Qt GUI.lnk" \
	...
	CreateShortCut "$SMPROGRAMS\sigrok\sigrok-qt\Uninstall.lnk" \
...
Section "Uninstall"
	...
	Delete "$SMPROGRAMS\sigrok\sigrok-qt\sigrok Qt GUI.lnk"
	Delete "$SMPROGRAMS\sigrok\sigrok-qt\Uninstall.lnk"
...
LangString DESC_Section1 ${LANG_ENGLISH} "This installs the sigrok Qt GUI, the protocol decoders, and all required libraries."
